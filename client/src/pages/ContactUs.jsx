                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                      <div className="bg-gradient-to-br from-emerald-800 to-teal-700 rounded-lg p-8 text-white h-full shadow-[0_0_30px_#10b98177]">
                        <h2 className="text-2xl font-bold mb-6 text-center lg:text-left">Get in Touch</h2>
                        <div className="space-y-6">
                          {/* Email */}
                          <div className="flex flex-col items-center lg:flex-row lg:items-start lg:space-x-4 space-y-2 lg:space-y-0">
                        ...
                        <div className="mt-8 pt-6 border-t border-emerald-600">
                          <h3 className="font-semibold text-emerald-300 mb-3 text-center lg:text-left">Follow Us</h3>
