        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">{settings.siteInfo.name || 'Animation Club'}</span>
            </div>
            ...
            <p className="text-sm text-gray-400">
              Established {settings.siteInfo.established || '2020'} | Building creative futures through animation
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/achievements" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Achievements
                </Link>
              </li>
              <li>
